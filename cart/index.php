            ...
            <div class="col-lg-8" id="cart-items-list">
                ...
                while ($item = pg_fetch_assoc($result_cart)):
                    ...
                    <div class="cart-item-card" id="cart-item-<?php echo $item['cart_item_id']; ?>">
                        <img src="/<?php echo htmlspecialchars($item['image_path'] ?? 'assets/images/placeholder.png'); ?>"
                        ...
                        <div class="cart-item-details">
                            ...
                            <div class="cart-item-actions">
                                <div class="quantity-control">
                                    <button class="quantity-btn" data-action="minus"
                                        data-id="<?php echo $item['cart_item_id']; ?>">-</button>
                                    <input type="text" readonly class="quantity-input" value="<?php echo $item['quantity']; ?>"
                                        data-id="<?php echo $item['cart_item_id']; ?>" max="<?php echo $item['stock']; ?>">
                                    <button class="quantity-btn" data-action="plus"
                                        data-id="<?php echo $item['cart_item_id']; ?>">+</button>
                                </div>
