            ...
            <div class="card-body">
                <div class="mb-3">
                    ...
                    <input type="number" class="form-control" id="price" name="price"
                        value="<?php echo $product['price']; ?>" required step="1000">
                </div>
                <div class="mb-3">
                ...
                <div class="mb-3">
                    <label for="images" class="form-label">Ganti Gambar (Opsional, Maks 5)</label>
                    <input class="form-control" type="file" id="images" name="images[]" multiple accept="image/*">
                    <small class="form-text text-muted">Jika Anda upload gambar baru, semua gambar lama akan
                        dihapus.</small>
                </div>
            </div>
        </div>
